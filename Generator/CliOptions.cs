...
public class CliOptions
{
    ...
    [Option("ffmpeg-binary-url", Required = false, Default = "https://github.com/BtbN/FFmpeg-Builds/releases/download/latest/ffmpeg-n8.0-latest-win64-gpl-shared-8.0.zip")]
