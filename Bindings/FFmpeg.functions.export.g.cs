...
public unsafe static partial class Raw
{
    ...
    /// <param name="flags">currently unused. Must be zero</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVPacketSideData* av_packet_side_data_add(ref AVPacketSideData* sd, int* nb_sd, AVPacketSideDataType type, void* data, nuint size, int flags);
    ...
    /// <param name="flags">Currently unused. Must be 0.</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_packet_side_data_from_frame(ref AVPacketSideData* sd, int* nb_sd, AVFrameSideData* src, uint flags);
    ...
    /// <param name="flags">currently unused. Must be zero</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVPacketSideData* av_packet_side_data_new(ref AVPacketSideData* psd, int* pnb_sd, AVPacketSideDataType type, nuint size, int flags);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_packet_side_data_to_frame(ref AVFrameSideData** sd, int* nb_sd, AVPacketSideData* src, uint flags);
    ...
    /// <param name="dict">the metadata storage dictionary</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_packet_unpack_dictionary(byte* data, nuint size, ref AVDictionary* dict);
    ...
    /// <param name="out_num_configs">On success, set to the number of elements in out_configs, excluding the terminator. Optional.</param>
    [DllImport(AVCODEC, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avcodec_get_supported_config(AVCodecContext* avctx, AVCodec* codec, AVCodecConfig config, uint flags, ref void* out_configs, int* out_num_configs);
    ...
    [DllImport(AVDEVICE, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    ...
    [DllImport(AVFILTER, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_buffersink_get_frame_flags(AVFilterContext* ctx, AVFrame* frame, BufferSinkFlags flags);
    ...
    [DllImport(AVFILTER, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_buffersrc_add_frame_flags(AVFilterContext* buffer_src, AVFrame* frame, AVBuffersrcFlag flags);
    
    /// <summary>Close the buffer source after EOF.</summary>
    [DllImport(AVFILTER, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_buffersrc_close(AVFilterContext* ctx, long pts, AVBuffersrcFlag flags);
    ...
    [DllImport(AVFILTER, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avfilter_graph_queue_command(AVFilterGraph* graph, [MarshalAs(UnmanagedType.LPUTF8Str)] string target, [MarshalAs(UnmanagedType.LPUTF8Str)] string cmd, [MarshalAs(UnmanagedType.LPUTF8Str)] string arg, FilterCmdFlags flags, double ts);
    ...
    public static extern int av_add_index_entry(AVStream* st, long pos, long timestamp, int size, int distance, IndexFlags flags);
    ...
    /// <param name="size">buffer size</param>
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_hex_dump_log(void* avcl, LogLevel level, byte* buf, int size);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_index_search_timestamp(AVStream* st, long timestamp, SeekFlags flags);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_pkt_dump_log2(void* avcl, LogLevel level, AVPacket* pkt, int dump_payload, AVStream* st);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVIndexEntry* avformat_index_get_entry_from_timestamp(AVStream* st, long wanted_timestamp, SeekFlags flags);
    ...
    /// <param name="data_out">Pointee is set to the command reply, the actual type depends on the command. This is allocated by the muxer and must be freed with ::av_free. For details on the actual data set here, consult the documentation of the respective ::AVFormatCommandID.</param>
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avformat_receive_command_reply(AVFormatContext* s, AVFormatCommandID id, ref void* data_out);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avformat_seek_file(AVFormatContext* s, int stream_index, long min_ts, long ts, long max_ts, SeekFlags flags);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avio_check([MarshalAs(UnmanagedType.LPUTF8Str)] string url, IOFlags flags);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avio_open(AVIOContext** s, [MarshalAs(UnmanagedType.LPUTF8Str)] string url, IOFlags flags);
    ...
    /// <param name="flags">flags which control how the resource indicated by url is to be opened</param>
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avio_open(ref AVIOContext* s, [MarshalAs(UnmanagedType.LPUTF8Str)] string url, IOFlags flags);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avio_open2(AVIOContext** s, [MarshalAs(UnmanagedType.LPUTF8Str)] string url, IOFlags flags, AVIOInterruptCB* int_cb, AVDictionary** options);
    ...
    /// <param name="options">A dictionary filled with protocol-private options. On return this parameter will be destroyed and replaced with a dict containing options that were not found. May be NULL.</param>
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int avio_open2(ref AVIOContext* s, [MarshalAs(UnmanagedType.LPUTF8Str)] string url, IOFlags flags, AVIOInterruptCB* int_cb, ref AVDictionary* options);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern long avio_seek(AVIOContext* s, long offset, IOSeekFlags whence);
    ...
    [DllImport(AVFORMAT, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern long avio_seek_time(AVIOContext* h, int stream_index, long timestamp, SeekFlags flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVAlphaMode av_alpha_mode_from_name([MarshalAs(UnmanagedType.LPUTF8Str)] string name);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVBufferRef* av_buffer_create(byte* data, nuint size, av_buffer_create_free_func free, void* opaque, int flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVBufferPool* av_buffer_pool_init(nuint size, av_buffer_pool_init_alloc_func alloc);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVBufferPool* av_buffer_pool_init2(nuint size, void* opaque, av_buffer_pool_init2_alloc_func alloc, av_buffer_pool_init2_pool_free_func pool_free);
    ...
    /// <param name="size">required new buffer size.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_buffer_realloc(ref AVBufferRef* buf, nuint size);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_copy(AVDictionary** dst, AVDictionary* src, DictWriteFlags flags);
    ...
    /// <param name="flags">Flags to use when setting entries in *dst</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_copy(ref AVDictionary* dst, AVDictionary* src, DictWriteFlags flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVDictionaryEntry* av_dict_get(AVDictionary* m, [MarshalAs(UnmanagedType.LPUTF8Str)] string key, AVDictionaryEntry* prev, DictReadFlags flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_parse_string(AVDictionary** pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string str, [MarshalAs(UnmanagedType.LPUTF8Str)] string key_val_sep, [MarshalAs(UnmanagedType.LPUTF8Str)] string pairs_sep, DictWriteFlags flags);
    ...
    /// <param name="flags">Flags to use when adding to the dictionary. ::AV_DICT_DONT_STRDUP_KEY and ::AV_DICT_DONT_STRDUP_VAL are ignored since the key/value tokens will always be duplicated.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_parse_string(ref AVDictionary* pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string str, [MarshalAs(UnmanagedType.LPUTF8Str)] string key_val_sep, [MarshalAs(UnmanagedType.LPUTF8Str)] string pairs_sep, DictWriteFlags flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_set(AVDictionary** pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string key, [MarshalAs(UnmanagedType.LPUTF8Str)] string value, DictWriteFlags flags);
    ...
    /// <param name="value">Entry value to add to *pm (will be av_strduped or added as a new key depending on flags). Passing a NULL value will cause an existing entry to be deleted.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_set(ref AVDictionary* pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string key, [MarshalAs(UnmanagedType.LPUTF8Str)] string value, DictWriteFlags flags);
    
    /// <summary>Convenience wrapper for av_dict_set() that converts the value to a string and stores it.</summary>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_set_int(AVDictionary** pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string key, long value, DictWriteFlags flags);
    
    /// <summary>Convenience wrapper for av_dict_set() that converts the value to a string and stores it.</summary>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_dict_set_int(ref AVDictionary* pm, [MarshalAs(UnmanagedType.LPUTF8Str)] string key, long value, DictWriteFlags flags);
    ...
    /// <param name="elem_data">Pointer to the data of the element to add. If `NULL`, the space of the newly added element is allocated but left uninitialized.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void* av_dynarray2_add(ref void* tab_ptr, int* nb_ptr, nuint elem_size, byte* elem_data);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVFrameSideData* av_frame_side_data_add(ref AVFrameSideData** sd, int* nb_sd, AVFrameSideDataType type, ref AVBufferRef* buf, uint flags);
    ...
    /// <param name="flags">Some combination of AV_FRAME_SIDE_DATA_FLAG_* flags, or 0.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVFrameSideData* av_frame_side_data_new(ref AVFrameSideData** sd, int* nb_sd, AVFrameSideDataType type, nuint size, uint flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_hwframe_map(AVFrame* dst, AVFrame* src, AVHWframeMap flags);
    ...
    /// <param name="flags">currently unused</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_image_fill_color(byte** dst_data, nint* dst_linesize, AVPixelFormat pix_fmt, uint* color, int width, int height, int flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_log(void* avcl, LogLevel level, [MarshalAs(UnmanagedType.LPUTF8Str)] string fmt);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_log_default_callback(void* avcl, LogLevel level, byte* fmt, byte* vl);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_log_format_line(void* ptr, LogLevel level, byte* fmt, byte* vl, byte* line, int line_size, int* print_prefix);
    ...
    /// <param name="print_prefix">used to store whether the prefix must be printed; must point to a persistent integer initially set to 1</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_log_format_line2(void* ptr, LogLevel level, byte* fmt, byte* vl, byte* line, int line_size, int* print_prefix);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern LogLevel av_log_get_level();
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_log_set_level(LogLevel level);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_eval_uint(void* obj, AVOption* o, [MarshalAs(UnmanagedType.LPUTF8Str)] string val, uint* uint_out);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVOption* av_opt_find(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string unit, OptFlags opt_flags, OptSearchFlags search_flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVOption* av_opt_find2(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string unit, OptFlags opt_flags, OptSearchFlags search_flags, void** target_obj);
    ...
    /// <param name="target_obj">if non-NULL, an object to which the option belongs will be written here. It may be different from obj if AV_OPT_SEARCH_CHILDREN is present in search_flags. This parameter is ignored if search_flags contain AV_OPT_SEARCH_FAKE_OBJ.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern AVOption* av_opt_find2(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string unit, OptFlags opt_flags, OptSearchFlags search_flags, ref void* target_obj);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, byte** out_val);
    ...
    /// <param name="out_val">value of the option will be written here</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, ref byte* out_val);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_array(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, uint start_elem, uint nb_elems, AVOptionType out_type, void* out_val);
    
    /// <summary>For an array-type option, get the number of elements in the array.</summary>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_array_size(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, uint* out_val);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_chlayout(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVChannelLayout* layout);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_dict_val(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVDictionary** out_val);
    
    /// <param name="out_val">The returned dictionary is a copy of the actual value and must be freed with av_dict_free() by the caller</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_dict_val(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, ref AVDictionary* out_val);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_double(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, double* out_val);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_image_size(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, int* w_out, int* h_out);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_int(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, long* out_val);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_key_value(byte** ropts, [MarshalAs(UnmanagedType.LPUTF8Str)] string key_val_sep, [MarshalAs(UnmanagedType.LPUTF8Str)] string pairs_sep, OptFlags flags, byte** rkey, byte** rval);
    ...
    /// <param name="rval">parsed value; must be freed using av_free()</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_key_value(ref byte* ropts, [MarshalAs(UnmanagedType.LPUTF8Str)] string key_val_sep, [MarshalAs(UnmanagedType.LPUTF8Str)] string pairs_sep, OptFlags flags, ref byte* rkey, ref byte* rval);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_pixel_fmt(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVPixelFormat* out_fmt);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_q(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVRational* out_val);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_sample_fmt(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVSampleFormat* out_fmt);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_get_video_rate(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, AVRational* out_val);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_is_set_to_default_by_name(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags);
    ...
    /// <param name="pairs_sep">character used to separate two pairs from each other</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_serialize(void* obj, OptFlags opt_flags, OptSerializeFlags flags, byte** buffer, byte key_val_sep, byte pairs_sep);
    ...
    /// <param name="pairs_sep">character used to separate two pairs from each other</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_serialize(void* obj, OptFlags opt_flags, OptSerializeFlags flags, ref byte* buffer, byte key_val_sep, byte pairs_sep);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, [MarshalAs(UnmanagedType.LPUTF8Str)] string val, OptSearchFlags search_flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_array(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, OptSearchFlags search_flags, uint start_elem, uint nb_elems, AVOptionType val_type, void* val);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_bin(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, byte* val, int size, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_chlayout(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVChannelLayout* layout, OptSearchFlags search_flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern void av_opt_set_defaults2(void* s, OptFlags mask, OptFlags flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_dict_val(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVDictionary* val, OptSearchFlags search_flags);
    ...
    /// <param name="search_flags">A combination of AV_OPT_SEARCH_*.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_dict2(void* obj, AVDictionary** options, OptSearchFlags search_flags);
    ...
    /// <param name="search_flags">A combination of AV_OPT_SEARCH_*.</param>
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_dict2(void* obj, ref AVDictionary* options, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_double(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, double val, OptSearchFlags search_flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_image_size(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, int w, int h, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_int(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, long val, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_pixel_fmt(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVPixelFormat fmt, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_q(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVRational val, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_sample_fmt(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVSampleFormat fmt, OptSearchFlags search_flags);
    
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_opt_set_video_rate(void* obj, [MarshalAs(UnmanagedType.LPUTF8Str)] string name, AVRational val, OptSearchFlags search_flags);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern int av_size_mult(nuint a, nuint b, ulong* r);
    ...
    [DllImport(AVUTIL, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern byte* av_strndup([MarshalAs(UnmanagedType.LPUTF8Str)] string s, nuint len);
    ...
    [DllImport(SWSCALE, CallingConvention = CallingConvention.Cdecl, ExactSpelling = true), SuppressUnmanagedCodeSecurity]
    public static extern SwsContext* sws_getCachedContext(SwsContext* context, int srcW, int srcH, AVPixelFormat srcFormat, int dstW, int dstH, AVPixelFormat dstFormat, SwsFlags flags, SwsFilter* srcFilter, SwsFilter* dstFilter, double* param);
